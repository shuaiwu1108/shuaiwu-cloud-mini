...
import com.shuaiwu.cloud.framework.mybatis.core.util.MyBatisUtils;
import com.shuaiwu.cloud.framework.redis.config.ShuaiwuCacheProperties;
import com.shuaiwu.cloud.framework.security.core.service.SecurityFrameworkService;
import com.shuaiwu.cloud.framework.tenant.core.aop.TenantIgnore;
import com.shuaiwu.cloud.framework.tenant.core.aop.TenantIgnoreAspect;
import com.shuaiwu.cloud.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.shuaiwu.cloud.framework.tenant.core.job.TenantJobAspect;
import com.shuaiwu.cloud.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.shuaiwu.cloud.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.shuaiwu.cloud.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.shuaiwu.cloud.framework.tenant.core.redis.TenantRedisCacheManager;
import com.shuaiwu.cloud.framework.tenant.core.security.TenantSecurityWebFilter;
import com.shuaiwu.cloud.framework.tenant.core.service.TenantFrameworkService;
import com.shuaiwu.cloud.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.shuaiwu.cloud.framework.tenant.core.web.TenantContextWebFilter;
import com.shuaiwu.cloud.framework.tenant.core.web.TenantVisitContextInterceptor;
import com.shuaiwu.cloud.framework.web.config.WebProperties;
import com.shuaiwu.cloud.framework.web.core.handler.GlobalExceptionHandler;
...
public class ShuaiwuTenantAutoConfiguration {
    ...
    public TenantFrameworkService tenantFrameworkService(TenantCommonApi tenantApi) {
        // 参见 https://gitee.com/zhijiantianya/shuaiwu-cloud/issues/IC6YZF
        try {
     ...
     */
    @Configuration
    @ConditionalOnClass(name = "com.shuaiwu.cloud.framework.mq.redis.core.RedisMQTemplate")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     ShuaiwuCacheProperties shuaiwuCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(shuaiwuCacheProperties.getRedisScanBatchSize()));
