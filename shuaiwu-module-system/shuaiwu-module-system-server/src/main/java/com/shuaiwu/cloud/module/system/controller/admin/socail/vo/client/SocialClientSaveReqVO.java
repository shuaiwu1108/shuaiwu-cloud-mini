package com.shuaiwu.cloud.module.system.controller.admin.socail.vo.client;
...
import com.shuaiwu.cloud.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "shuaiwu商城")
