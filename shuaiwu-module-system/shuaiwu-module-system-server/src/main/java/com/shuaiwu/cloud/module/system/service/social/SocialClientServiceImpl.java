package com.shuaiwu.cloud.module.system.service.social;
...
import com.shuaiwu.cloud.framework.common.enums.UserTypeEnum;
import com.shuaiwu.cloud.framework.common.pojo.PageResult;
import com.shuaiwu.cloud.framework.common.util.cache.CacheUtils;
...
import com.shuaiwu.cloud.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.shuaiwu.cloud.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.shuaiwu.cloud.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.shuaiwu.cloud.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.shuaiwu.cloud.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.shuaiwu.cloud.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.shuaiwu.cloud.module.system.dal.dataobject.social.SocialClientDO;
import com.shuaiwu.cloud.module.system.dal.mysql.social.SocialClientMapper;
import com.shuaiwu.cloud.module.system.dal.redis.RedisKeyConstants;
import com.shuaiwu.cloud.module.system.enums.social.SocialTypeEnum;
import com.shuaiwu.cloud.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.shuaiwu.cloud.framework.common.util.collection.MapUtils.findAndThen;
import static com.shuaiwu.cloud.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.shuaiwu.cloud.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.shuaiwu.cloud.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${shuaiwu.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${shuaiwu.wxa-subscribe-message.miniprogram-state:formal}")
