...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.shuaiwu.cloud";
    private static final String ARTIFACT_ID = "shuaiwu";
    private static final String PACKAGE_NAME = "com.shuaiwu.cloud";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.shuaiwu.cloud";
        String artifactIdNew = "shuaiwu";
        String packageNameNew = "com.shuaiwu.cloud";
